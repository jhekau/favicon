...
/*
go test ./internal/service/thumb/ -v -short -count=1 -race -coverprofile="coverage.out" -coverpkg='./internal/service/thumb,./internal/service/convert' -run="Test_Inegration_ConverterCheckSource" ;`
go tool cover -html="coverage.out" ;`
rm coverage.out
*/
